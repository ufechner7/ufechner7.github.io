...
- There is no easy-to-use, well-integrated GUI library. Yes, you can use [QML.jl](https://github.com/barche/QML.jl) or [GTK4.jl](https://github.com/JuliaGtk/Gtk4.jl) and many others, but they all have their issues, one of the issues is the lack of Julia specific documentation.
